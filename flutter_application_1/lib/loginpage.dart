    ...
    return Scaffold(appBar: AppBar(title: const Center(
      child:Text(
        ...
        body:Form(
            ...
            child: SingleChildScrollView(child:Container(decoration:const BoxDecoration(image: DecorationImage(fit:BoxFit.cover,image: AssetImage(imageaddress.bg))),child:  Column(
   ...
   return Row(
      ...
      children: [
        const Flexible(
          flex: 1,
          child: const Padding(
              padding: EdgeInsets.all(10), child: const Text('20',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold))),
        ),
        Flexible(
            flex: 1,
            child: Padding(
    ...
    return  Row(
      ...
      children: [
        const Flexible(
          ...
          child: const Padding(
              padding: EdgeInsets.all(10),
              child: const Text('200', style: TextStyle(
                  fontSize: 20, fontWeight: FontWeight.bold))),
        ),
        Flexible(
            flex: 1,
      ...
      onPressed: () async {
        ...
        if (_formKey.currentState!.validate()) {
          int totalMoney = ten * 10 +
              ...
              fivehundred * 500 +
              twohundred * 200;
          int total = ten + twenty + fifty + hundred +
              fivehundred +
              twohundred;
          ...
          await prefs.setString(
              'twohundred', twohundred.toString());
          await prefs.setString(
